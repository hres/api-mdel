...
function goDhprLangUrl(lang, pType) {
    ...
    var langUrl = lang == 'fr' ? "produit-pharmaceutique-resultat.html" : "drug-product-result.html";
...
function goDhprLangUrlByID(lang, pType) {
    var linkID = getParameterByName("linkID");
    var langSwitch = lang == 'en' ? "fr" : "en";
    var langUrl = "drug-product-result.html?" + langSwitch + ".html?linkID=" + linkID + "&pType=" + pType + "&lang=" + langSwitch;
    return langUrl;
}
...
function formatedPM(pmName, lang) {
